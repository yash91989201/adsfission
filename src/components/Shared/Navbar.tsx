    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between ">
        ...
        <div className="flex items-center justify-between space-x-8">
          ...
          <Link
            href="#"
            className="flex items-center justify-center space-x-3 rounded-sm border border-transparent bg-primary-300 px-6 py-3 text-lg text-white outline-none transition-all duration-500 hover:border-primary-200 hover:bg-white hover:text-primary-200"
          >
