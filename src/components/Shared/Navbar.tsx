...
export default function Navbar() {
  ...
  return (
    <header
      className={` w-full py-4 px-3 transition-all
    ...
    >
      <div className="flex items-center justify-between max-w-6xl mx-auto ">
        ...
        <aside
          className={`absolute top-0 z-50  h-screen w-64 bg-primary-600 py-3 px-6 transition-all delay-100 duration-300 ease-in-out md:hidden ${
