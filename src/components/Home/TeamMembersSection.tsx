      ...
      <div className="mx-auto flex max-w-6xl flex-col items-center">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 xs:grid-cols-2 md:grid-cols-3">
          {TEAM_MEMBER.map(({ name, designation }, index) => (
            <Bounce key={index}>
              <div className="group relative flex w-56 cursor-default flex-col items-center overflow-hidden rounded border bg-white text-center text-primary-600 shadow-lg duration-300 md:w-64 ">
