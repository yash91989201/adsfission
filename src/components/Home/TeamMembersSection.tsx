  ...
  return (
    <section className="px-8 py-14 md:px-12 md:py-16 lg:px-16 lg:py-24 xl:px-0 xl:py-28">
      <div className="mx-auto flex max-w-6xl flex-col items-center">
        <h3 className="text-center text-sm font-bold text-primary-300  ">
          SERVICES
        </h3>
        <h2 className="text-center text-3xl font-bold sm:max-w-sm md:max-w-xl md:text-5xl lg:text-6xl">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 xs:grid-cols-2 md:grid-cols-3">
          {TEAM_MEMBER.map(({ name, designation }, index) => (
            <div
              key={index}
              className="group relative flex w-56 cursor-default flex-col items-center overflow-hidden rounded border bg-white text-center text-primary-600 shadow-lg duration-300 md:w-64 "
            >
