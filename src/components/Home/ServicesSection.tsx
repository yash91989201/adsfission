      ...
      <div className="mx-auto flex max-w-6xl flex-col items-center ">
        ...
        <div className="mt-16 grid grid-cols-1 gap-6 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {SERVICES.map(({ heading, subText, Icon, iconCol }, index) => (
            <Zoom key={index}>
              <div className="group relative flex max-w-[240px] cursor-default flex-col items-center space-y-3  rounded-md border bg-white py-8 text-center text-primary-600 shadow-lg transition-all duration-300 hover:bg-primary-300 hover:text-white">
